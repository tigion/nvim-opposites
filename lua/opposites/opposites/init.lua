...
function M.switch_word_to_opposite_word(line, cursor, quiet)
  ...
  if #results < 1 then
    ...
    if not quiet and config.options.notify.not_found then notify.info(row_col_str .. ' No opposite word found') end
    return false
